...
import { HomeBillboardColumnType } from "./Columns";

interface RowActionInterface {
  billboardRow: HomeBillboardColumnType;
}
...
export default function RowAction({ billboardRow }: RowActionInterface) {
  ...
  const { id: billboardId } = billboardRow;
  ...
  function onUpdate() {
    router.push(`/${storeId}/home-billboard/${billboardId}`);
  }
  ...
  async function onDelete() {
    try {
      ...
      await axios.delete(`/api/${storeId}/home-billboard/${billboardId}`);
      router.refresh();
